...
from MinatoNamikaze.modules.helper_funcs.string_handling import split_quotes
from MinatoNamikaze.modules.log_channel import loggable
from MinatoNamikaze.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Minato's sticker
        keyboard = None
