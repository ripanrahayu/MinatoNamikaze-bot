...
def get_user_list(config, key):
    with open('{}/MinatoNamikaze/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    OWNER_ID = 1657187491  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "DarkGod14"
    SUPPORT_CHAT = 'MinatoNamikazeSupport'  #Your own group for support, do not add the @
